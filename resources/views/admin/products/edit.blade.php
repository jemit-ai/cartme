...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h3 class="text-3xl font-bold text-gray-800 tracking-tight">Edit Product</h3>
            <p class="text-gray-500 mt-1">Update product details and inventory</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="stock" class="block text-sm font-semibold text-gray-700 mb-2">Stock Inventory</label>
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <div class="w-full h-48 rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center bg-gray-50 overflow-hidden relative">
                                @if($product->image)
                                    <img src="{{ asset($product->image) }}" id="preview-image" class="w-full h-full object-cover">
                                @else
                    ...
                    <div>
                        ...
                        <select name="category_id" id="category_id" 
                            ...
                            @isset($categories)
                                ...
                                @endforeach
                            @else
                                <option value="{{ $product->category_id }}" selected>{{ $product->category->name ?? 'Uncategorized' }}</option>
                            @endisset
                        </select>
                        @error('category_id')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
